...
namespace Lucky.Interactive
{
    ...
    public class GameCursor
    {
        ...
        public static Vector2 MouseScreenPosition
        {
            get
            {
                Vector3 screenPos = UseCustomMouseScreenPosition ? CustomMouseScreenPosition : Input.mousePosition.WithZ(0);
                // 如果我们 focus mode 为 unfocused 且当前窗口没有 game, 那么 input 就拿不到正确的值, 会变成 infinity
        ...
        public void Update()
        {
            ...
            {
                PreviousMouseWorldPosition = MouseWorldPosition; // 防止鼠标移动到奇怪的地方然后飞速移到 interactable 上然后点击
        ...
        {
            return GetTopHitInteractableAt<InteractableUI>(screenPosition, filter)
